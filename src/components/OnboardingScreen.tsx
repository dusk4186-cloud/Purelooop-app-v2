        ...
        {showCityPrompt ? (
          <div className="flex flex-col gap-4 mb-8 animate-in fade-in slide-in-from-bottom-4 text-left">
            ...
            <button 
              ...
              disabled={!guestCity}
              className="w-full py-4 rounded-xl font-semibold bg-action-primary text-white dark:text-slate-950 disabled:opacity-50 transition-all mt-2"
            >
              Start Browsing
            </button>
            <button 
          ...
          <div className="flex flex-col gap-4 mb-8">
            <button 
              ...
              className="w-full py-4 rounded-xl font-semibold bg-accent-primary text-white dark:text-slate-950 shadow-[0_4px_16px_var(--color-accent-glow)] active:scale-95 transition-transform"
            >
              Get Started
            </button>
            <button 
