import { ArrowLeft, ChevronRight, LogOut, MapPin, HelpCircle, Moon, Sun, User, Bell, FileText } from 'lucide-react';
...
export default function ProfileScreen({ onNavigate, hasActiveOrder }: ProfileProps) {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-bg-main">
      ...
      {/* Bottom Nav */}
      <BottomNav activeScreen="profile" onNavigate={onNavigate} hasActiveOrder={hasActiveOrder} />
    </div>
  );
}
